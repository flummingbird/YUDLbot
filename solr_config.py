#simple config file that builds up the solr query. need to make this a bit more changeable
...
#&fl=PID%2C+mods_titleInfo_title_ms&wt=json&indent=true&rows=1
#QUERY = 'q=goat'
# NOT = '+AND+NOT+'
#QUERY =QUERY + NOT
